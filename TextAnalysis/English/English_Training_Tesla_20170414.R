...
df$post_texts
df$ptext <- sapply(df$post_texts, removeURL)
...
t_m2 <- t(m2)
# 연관단어 탐색 #
rules2 <- apriori(t_m2, parameter = list(support = .08))
#as(m3,"transactions")
...
write.table(aresult,'arule_noise.csv', fileEncoding ="UTF-8")
getwd()
